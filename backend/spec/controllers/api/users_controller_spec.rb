...
RSpec.describe Api::UsersController, type: :controller do
  describe 'POST #create' do
    it 'should render an error if a username or password is not given' do
      post :create,
           params: { user: { username: '', password: 'password', email: 'cat@gmail.com', name: 'Callie', city: 'SF', state: 'CA', phone_number: '555-6782' } }, format: :json
      expect(response).to have_http_status(422)
    end

    it 'should validate password is at leaset 6 characters long' do
      post :create,
           params: { user: { username: 'calliecat', password: '', email: 'cat@gmail.com', name: 'Callie', city: 'SF', state: 'CA', phone_number: '555-6782' } }, format: :json
      expect(response).to have_http_status(422)
    end
  end
  ...
  describe 'GET #show' do
    it 'should render the show template if user is found' do
      user = User.create!(username: 'calpal', password: 'password', email: 'callie@gmail.com', name: 'Callie',
